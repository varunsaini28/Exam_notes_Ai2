...
- If REVISION MODE is ON:
  ...
  - Content must feel like:
    - last-day revision
    - 10-minute exam cheat sheet
  - revisionPoints MUST summarize ALL important facts

- If REVISION MODE is OFF:
  - Notes MUST be EXTREMELY DETAILED and COMPREHENSIVE
  - ALWAYS provide LONG, THOROUGH explanations
  - Each topic MUST include:
    - Complete definition with all key terms
    - In-depth explanation covering all aspects
  ...
  - Paragraph length: minimum 20-30 lines per major concept
  - Include ALL relevant details, formulas, and exceptions
  - Explain underlying principles and reasoning
  - Connect concepts across the topic
  - NO skimping on details - be exhaustive
  - Think of this as comprehensive study material, not quick notes
